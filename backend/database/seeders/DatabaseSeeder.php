    ...
    public function run(): void
    {
        ...
        $categories = [
            [
                ...
                'name' => 'Coffees',
                'slug' => 'coffees',
                'description' => 'Artisanal espresso and coffee drinks crafted with premium roasted beans.',
                'display_order' => 1,
                'is_active' => true,
            ],
            [
                ...
                'name' => 'Roasts',
                'slug' => 'roasts',
                'description' => 'Freshly roasted whole beans and single-origin roast bags.',
                'display_order' => 2,
                'is_active' => true,
            ],
            [
                ...
                'name' => 'Ice Creams',
                'slug' => 'ice-creams',
                'description' => 'Creamy gelato, artisanal ice creams, and affogato scoops.',
                'display_order' => 3,
                'is_active' => true,
            ],
            [
                ...
                'name' => 'Cocktails',
                'slug' => 'cocktails',
                'description' => 'Signature coffee cocktails, espresso martinis, and mocktails.',
                'display_order' => 4,
                'is_active' => true,
            ],
            [
                ...
                'name' => 'Snacks',
                'slug' => 'snacks',
                'description' => 'Savory cafe snacks, paninis, avocado toast, and bites.',
                'display_order' => 5,
                'is_active' => true,
            ],
            [
                ...
                'name' => 'Bakery',
                'slug' => 'bakery',
                'description' => 'Freshly baked croissants, viennoiserie, and sourdough bread.',
                'display_order' => 6,
                'is_active' => true,
            ],
        ];
